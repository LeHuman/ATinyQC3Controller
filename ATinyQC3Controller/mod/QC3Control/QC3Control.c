...
uint8_t _continuousMode = 0;   //!< Are we in continuous adjustment (QC3) mode?
...
void QC3_set9V() {
    if (_continuousMode) { // Transition from continuous to discrete values requires first going to 5V
        QC3_set5V();
    }
